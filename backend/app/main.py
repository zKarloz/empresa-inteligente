...
from app.api.biometria import router as biometria_router
...
from app.core.security import protect_api
...
app = FastAPI(
    dependencies=[Depends(protect_api)],
    docs_url=None,
    redoc_url=None,
    openapi_url=None,
...
async def test_database():
    ...
    return {"database": "conectada", "clientes": cantidad_clientes}
